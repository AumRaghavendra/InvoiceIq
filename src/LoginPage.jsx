...
export default function LoginPage() {
  ...
  const handleSubmit = async () => {
    ...
    setError("")
    try {
      const res = await axios.post("https://invoiceiq-backend-zjma.onrender.com/api/auth/login", form)
    ...
    <div className="min-h-screen flex flex-col" style={{ background: "#F9FAFB" }}>
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="bg-white rounded-2xl p-8 w-full max-w-sm" style={{ border: "0.5px solid #E5E7EB" }}>
          ...
          <p className="text-sm mb-6" style={{ color: "#6B7280" }}>Sign in to InvoiceIQ</p>
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-xs text-center" style={{ color: "#6B7280" }}>
              ...
              <Link to="/signup" style={{ color: "#4F46E5", textDecoration: "underline", textUnderlineOffset: "4px" }}>Sign up</Link>
            </p>
          </div>
        </div>
      </div>
